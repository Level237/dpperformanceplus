<footer class="bg-[#001026] text-white pt-20 pb-10 relative overflow-hidden">
    ...
    <div
        class="absolute top-0 left-0 w-64 h-64 bg-orange-600/5 rounded-full blur-[80px] -translate-x-1/2 -translate-y-1/2">
    </div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 lg:gap-16 mb-20">
            ...
            <div class="flex flex-col space-y-6">
                ...
                <div class="flex items-center gap-4 pt-4">
                    ...
                    <a href="#"
                        class="w-10 h-10 rounded-full bg-white/5 flex items-center justify-center hover:bg-orange-600 transition-colors duration-300">
                        <svg class="w-5 h-5 fill-current" viewBox="0 0 24 24">
                            <path
            ...
            <div class="flex flex-col space-y-6">
                ...
                <div class="space-y-5">
                    <a href="tel:4383403707" class="flex items-center gap-4 group">
                        <div
                            class="w-10 h-10 rounded-lg bg-blue-600/10 flex items-center justify-center group-hover:bg-blue-600 transition-colors duration-300">
                    ...
                    <div class="flex items-start gap-4">
                        ...
                        <div class="font-light text-blue-100/60 leading-tight">
                            <p>Terrebonne, QC</p>
                            <p class="text-orange-500 font-medium uppercase text-xs mt-1 tracking-wider">Sur rendez-vous
                                uniquement</p>
                        </div>
                    </div>
                    ...
                    <a href="mailto:info@dpperformanceplus.ca" class="flex items-center gap-4 group">
                        <div
                            class="w-10 h-10 rounded-lg bg-orange-600/10 flex items-center justify-center group-hover:bg-orange-600 transition-colors duration-300">
                            <svg class="w-5 h-5 text-orange-400 group-hover:text-white" fill="none"
